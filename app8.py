...
# =========================================================================
# 📚 BASE DE DATOS REAL EXTRAÍDA DE TU DOCUMENTO (5to A 10mo SEMESTRE)
# =========================================================================
CATALOGO_MATERIAS = [
    # --- 5to SEMESTRE ---
    ...
    # --- MATERIAS OPTATIVAS (Disponibles para toda la carrera avanzada) ---
    {"nrc": "58202", "clave": "PSIS 600", "materia": "Educacion Inclusiva", "secc": "001", "dias": "AJ", "hora": "1100-1229", "profesor": "DE LA OLIVA GRANIZO DAVID", "semestre": "Optativa"},
    {"nrc": "58203", "clave": "PSIS 601", "materia": "Educacion No Formal", "secc": "001", "dias": "LM", "hora": "0900-1029", "profesor": "TLALPAN RUIZ MARIA GUADALUPE", "semestre": "Optativa"},
    {"nrc": "58205", "clave": "PSIS 602", "materia": "Modeliz de Procesos Cognitivos", "secc": "001", "dias": "AJ", "hora": "1300-1429", "profesor": "DIAZ-CARDENAS ALFONSO FELIPE", "semestre": "Optativa"},
    {"nrc": "58210", "clave": "PSIS 605", "materia": "Orientacion Familiar en Ed.", "secc": "001", "dias": "AJ", "hora": "1100-1229", "profesor": "DEGANTE REYES MONICA ALEJANDRA", "semestre": "Optativa"},
    {"nrc": "58218", "clave": "PSIS 606", "materia": "Procesos de Adq y Dilo de la L", "secc": "001", "dias": "AJ", "hora": "1300-1429", "profesor": "SANCHEZ CID JOSE ELIAS", "semestre": "Optativa"},
    {"nrc": "58222", "clave": "PSIS 603", "materia": "Neuropsicologia", "secc": "001", "dias": "AJ", "hora": "0900-1029", "profesor": "BONILLA SANCHEZ MARIA DEL ROSARIO", "semestre": "Optativa"},
    {"nrc": "58226", "clave": "PSIS 607", "materia": "Psicologia y Creatividad", "secc": "001", "dias": "LM", "hora": "1100-1229", "profesor": "DEGANTE REYES MONICA ALEJANDRA", "semestre": "Optativa"},
    {"nrc": "58248", "clave": "PSIS 609", "materia": "Prev. e Interv. en Adicciones", "secc": "OO1", "dias": "LM", "hora": "1100-1229", "profesor": "RODRIGUEZ - CASTILLO KARINA", "semestre": "Optativa"},
    {"nrc": "58250", "clave": "PSIS 611", "materia": "Terapia Breve", "secc": "OO2", "dias": "AJ", "hora": "1100-1229", "profesor": "STANGE - ESPINOLA ISABEL DEL ROSARIO", "semestre": "Optativa"},
    {"nrc": "58253", "clave": "PSIS 614", "materia": "Violencia Intrafamiliar", "secc": "OO1", "dias": "AJ", "hora": "1700-1829", "profesor": "RODRIGUEZ - CASTILLO KARINA", "semestre": "Optativa"},
    {"nrc": "58254", "clave": "PSIS 612", "materia": "Terapia Cognitivo Conductual", "secc": "OO2", "dias": "AJ", "hora": "1500-1629", "profesor": "RODRIGUEZ - CASTILLO KARINA", "semestre": "Optativa"},
    {"nrc": "58257", "clave": "PSIS 613", "materia": "Terapia PsicoanalItica", "secc": "OO1", "dias": "AJ", "hora": "1300-1429", "profesor": "VEGA - SIMONT EDMUNDO", "semestre": "Optativa"},
    {"nrc": "58439", "clave": "PSIS 620", "materia": "Psicologia Social de las Masas", "secc": "OO1", "dias": "LM", "hora": "1500-1629", "profesor": "CHAVEZ - GONZALEZ ERIKA", "semestre": "Optativa"},
    {"nrc": "58444", "clave": "PSIS 615", "materia": "Perspectiva de Genero y Psi", "secc": "OO1", "dias": "AJ", "hora": "1100-1229", "profesor": "SANCHEZ - HERNANDEZ GRACIELA", "semestre": "Optativa"},
    {"nrc": "58452", "clave": "PSIS 616", "materia": "Perspectivas Medioambientales", "secc": "OO1", "dias": "LM", "hora": "1100-1229", "profesor": "ROMERO - HORAN MARIA GUILLERMINA", "semestre": "Optativa"},
    {"nrc": "58581", "clave": "PSIS 622", "materia": "Calidad Org. e ISO 14000", "secc": "OO1", "dias": "LM", "hora": "0900-1029", "profesor": "CARRO - MEZA DULCE CAROLINA", "semestre": "Optativa"},
    {"nrc": "58649", "clave": "PSIS 626", "materia": "Liderazgo en las Organizacion", "secc": "OO1", "dias": "AJ", "hora": "1100-1229", "profesor": "MOTO - MARTINEZ TERESA LEDOINA", "semestre": "Optativa"},
    {"nrc": "58662", "clave": "PSIS 627", "materia": "Psicologia del Consumidor", "secc": "OO1", "dias": "LM", "hora": "1500-1629", "profesor": "FRAGOSO - LUZURIAGA ROCIO", "semestre": "Optativa"}
]
...
semestre_seleccionado = st.sidebar.selectbox(
    ...
    index=0  # Inicia por defecto en 5to semestre
)
...
# --- FILTRADO EN TIEM realtime ---
lista_materias_trabajo = [m for m in CATALOGO_MATERIAS if m['semestre'] == semestre_seleccionado or m['semestre'] == "Optativa"]
