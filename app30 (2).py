...
with atrasadas_expander:
    st.markdown(
        ...
        "Las materias del semestre activo que las requieran como prerequisito serán <b>eliminadas automáticamente</b> del horario.</small>",
    ...
    # Semestres anteriores al activo (una materia atrasada es de semestres previos)
    ...
    if not semestres_previos:
        ...
        # Obtener materias únicas de ese semestre
        materias_del_sem = {}
        ...
        if materias_del_sem:
            ...
            for disp in seleccionadas_display:
                claves_atrasadas.add(opciones_display[disp])
