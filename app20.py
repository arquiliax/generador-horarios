...
def generar_horario_estricto(lista_materias, optativas_seleccionadas, profesores_prioritarios, lm_lims, aj_lims, v_lims, omitir_viernes, max_intentos=5000):
    ...
    for clave, opciones in materias_unicas.items():
        ...
        # Filtrar si quedan fuera de los "Horarios de Referencia" seleccionados
...
# =========================================================================
# ⏱️ NUEVA SECCIÓN: HORARIOS DE REFERENCIA DINÁMICOS
# =========================================================================
st.sidebar.markdown("---")
...
# Diccionario utilitario para mostrar números en formato de hora amigable (HH:MM)
horas_visibles = {
...
# Subsección 1: Lunes y Miércoles
...
if omitir_viernes:
    ...
    v_rango = (700, 2100) # Valor por defecto ignorado por el motor
else:
...
if st.button("🎲 Calcular Horario Óptimo", type="primary"):
    ...
    if total_materias_solicitadas > 8:
        ...
        # Pasamos los rangos seleccionados (Tuplas de inicio y fin) directamente al motor algorítmico
