...
st.markdown("""
<style>
/* Fondo degradado azul cielo -> celeste claro (igual que la imagen) */
[data-testid="stAppViewContainer"] {
    background: linear-gradient(180deg, #0077b6 0%, #48cae4 45%, #caf0f8 100%) !important;
}
[data-testid="stAppViewContainer"] > .main {
    background: transparent !important;
}
/* Sidebar con fondo semitransparente para que contraste */
...
/* Título y textos principales más legibles sobre el fondo azul */
h1, h2, h3, .stSubheader {
    color: #ffffff !important;
    text-shadow: 0 1px 4px rgba(0,0,0,0.25);
}
/* Cards / dataframes con fondo blanco semitransparente */
[data-testid="stDataFrame"], .stTable, .stDataFrame {
...
/* Quitar fondo blanco del block container */
.block-container {
    background: transparent !important;
    padding-top: 2rem;
}
