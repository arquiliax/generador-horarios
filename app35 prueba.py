...
CATALOGO_MATERIAS = [
    ...
    {"nrc": "56827", "clave": "PSIS 013", "materia": "Psi.del Desarrollo Humano III", "secc": "001", "dias": "AJ", "hora": "0900-1059", "profesor": "LIMA - TIZCARENO SILVIA CAROLINA", "semestre": "3er Semestre"},
    ...
    {"nrc": "56876", "clave": "PSIS 012", "materia": "Teorias del Aprendizaje",("nrc"): 56876, ("clave"): PSIS 012, ("materia"): Teorias del Aprendizaje, ("secc"): 002, ("dias"): LM, ("hora"): 1500-1659, ("profesor"): DURAN SORIANO MARIA DEL ROSIO, ("semestre"): 3er Semestre},
    {"nrc": "56881",("nrc"): 56881, ("clave"): PSIS 013, ("materia"): Psi.del Desarrollo Humano III, ("secc"): 002, ("dias"): AJ, ("hora"): 1700-1859, ("profesor"): CANTERO-ANGULO MARIA DEL PILAR, ("semestre"): 3er Semestre},
                ...
                with st.expander(f"{label} ({len(profs)})", expanded=False):
                    for nombre_display, materias in profs:
                        ...
                        st.markdown(
                            ...
                            f"<span style='color:#555;font-size:11px;'>({mats_str})</span>"
                            f"</div>",
                            unsafe_allow_html=True
                        )
